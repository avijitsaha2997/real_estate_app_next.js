...
import SinglePropertyAreaFilterMob from "./SinglePropertyAreaFilterMob";

const SinglePropertyAreaFilterSearch = (props) => {
  const {
    filterListData,
    homeData,
    singleDevData,
...
export default SinglePropertyAreaFilterSearch;
